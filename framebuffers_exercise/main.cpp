...
int main()
{
    ...
    // -------------------------
    Shader shader((workDir+"/data/shaders/framebuffers_exercise/framebuffers.vs").c_str(),
		(workDir + "/data/shaders/framebuffers_exercise/framebuffers.fs").c_str() );
    Shader screenShader((workDir + "/data/shaders/framebuffers_exercise/framebuffers_screen.vs").c_str(),
		(workDir + "/data/shaders/framebuffers_exercise/framebuffers_screen.fs").c_str());
    ...
    // load textures
    // -------------
    unsigned int cubeTexture = loadTexture((workDir+"/data/images/marble.jpg").c_str());
    unsigned int floorTexture = loadTexture((workDir + "/data/images/metal.png").c_str());
